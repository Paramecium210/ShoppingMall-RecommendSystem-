...
public interface CommentMapper {
    ...
    */
    ...
    @Select("select * from comment where user_id =#{userId} and goods_id = #{goodsId}")
    Comment selectByUserIdAndGoodsId(@Param("userId") Integer userId, @Param("goodsId") Integer goodsId);
