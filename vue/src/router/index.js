...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'adminPerson', name: 'AdminPerson', meta: { name: 'Admin' }, component: () => import('../views/manager/AdminPerson') },
      { path: 'businessPerson', name: 'BusinessPerson', meta: { name: 'Business' }, component: () => import('../views/manager/BusinessPerson') },
      { path: 'password', name: 'Password', meta: { name: 'Password' }, component: () => import('../views/manager/Password') },
      { path: 'type', name: 'Type', meta: { name: 'Type' }, component: () => import('../views/manager/Type') },
      { path: 'goods', name: 'Goods', meta: { name: 'Goods' }, component: () => import('../views/manager/Goods') },
      { path: 'orders', name: 'Orders', meta: { name: 'Orders' }, component: () => import('../views/manager/Orders') },
      { path: 'comment', name: 'Comment', meta: { name: 'Comment' }, component: () => import('../views/manager/Comment') },
    ]
  },
  {
    path: '/front',
    ...
    children: [
      ...
      { path: 'type', name: 'Type', meta: { name: '商品种类' }, component: () => import('../views/front/Type') },
      { path: 'collect', name: 'Collect', meta: { name: '收藏' }, component: () => import('../views/front/Collect') },
