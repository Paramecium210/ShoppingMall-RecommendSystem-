  ...
  <div class="main-content">
    <div style=" display: flex; width: 70%; background-color: white;margin: 30px auto; border-radius: 20px">
      <div style="flex: 1; padding: 0 20px">
        <div style="font-size: 18px; color: #000000FF; line-height: 80px; border-bottom: #cccccc 1px solid">The result of "{{name}}"</div>
        <div style="margin: 20px 0">
          <el-row :gutter="20">
            <el-col :span="6" style="margin-bottom: 20px" v-for="item in goodsData" >
              ...
              <div style="margin-top: 15px; font-weight: 500; font-size: 16px; width: 160px; color: #000000FF; text-overflow: ellipsis; overflow: hidden; white-space: nowrap">
                {{ item.name }}</div>
      ...
      <div style="width: 250px; padding: 0 20px; border-left: #cccccc 1px solid">
        <div style="font-size: 18px; color: #000000FF; line-height: 80px; border-bottom: #cccccc 1px solid">Recommend for you</div>
        <div style="margin: 20px 0; padding: 0 20px">
          <div style="margin-bottom: 20px">
            ...
            <div style="margin-top: 15px; font-weight: 500; font-size: 16px; width: 160px; color: #000000FF; text-overflow: ellipsis; overflow: hidden; white-space: nowrap">hhrth</div>
            <div style="margin-top: 5px; font-size: 20px; color: #FF5000FF">227/rhr</div>
          </div>
          </div>
      </div>
    </div>
