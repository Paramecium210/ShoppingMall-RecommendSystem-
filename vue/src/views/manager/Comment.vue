<template>
  <div>
    <div class="search">
      <el-input placeholder="Enter the comment" style="width: 200px" v-model="content"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="goodsName" label="Goods name" show-overflow-tooltip></el-table-column>
