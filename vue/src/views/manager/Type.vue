<template>
  <div>
    <div class="search">
      <el-input placeholder="Enter the type of the goods" style="width: 200px" v-model="name"></el-input>
    ...
    <div class="operation">
      ...
      <el-button type="danger" plain @click="delBatch">Ditch delete</el-button>
    </div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="TypeName" show-overflow-tooltip></el-table-column>
