  ...
  <div>
    <el-card style="width: 50%">
      <el-form :model="user" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="BusinessName" prop="name">
          <el-input v-model="user.name" placeholder="BusinessName"></el-input>
        </el-form-item>
        ...
        <el-form-item label="Status" prop="status">
          <el-input v-model="user.status" placeholder="Status" disabled="true"></el-input>
        </el-form-item>
